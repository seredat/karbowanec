...
//---------------------------------------------------------------------------
Checkpoints::Checkpoints(Logging::ILogger &log, bool is_trailing_checkpoint_allowed) : logger(log, "checkpoints"), m_is_deep_reorg_allowed(is_trailing_checkpoint_allowed) {
}
//---------------------------------------------------------------------------
